...
(function($){
	...
	$.fn.portamento = function(options) {
		...
		var containerMarginFix = parseFloat(float_container.css('marginTop').replace(/auto/, 100));
	...
	$.fn.portamento.defaults = {
	  ...
	  'gap'					: 80, // the gap (in pixels) left between the top of the viewport and the top of the panel
